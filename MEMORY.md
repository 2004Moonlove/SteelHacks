...
- One-sentence entry (confirmed 2026-09-20): users should be able to start with one short, natural sentence rather than a detailed scenario brief. Example catalogs should reflect that entry style; missing information remains unknown or reviewable rather than being invented to complete the comparison.
